...
struct Sphere {
	...
	__host__ __device__ Sphere(double r, const Vector3 &p, const Vector3 &e, const Vector3 &f, Reflection_t reflection_t) : r(r), p(p), e(e), f(f), reflection_t(reflection_t){}
